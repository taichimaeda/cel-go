...
func (b BuiltinID) String() string {
	...
	case BuiltinListContainsIntSlice:
		return "list_contains_int_slice"
	case BuiltinListContainsIntArray:
		return "list_contains_int_array"
	case BuiltinListContainsUintSlice:
		return "list_contains_uint_slice"
	case BuiltinListContainsUintArray:
		return "list_contains_uint_array"
	case BuiltinListContainsFloatSlice:
		return "list_contains_float_slice"
	case BuiltinListContainsFloatArray:
		return "list_contains_float_array"
	case BuiltinListContainsBoolSlice:
		return "list_contains_bool_slice"
	case BuiltinListContainsBoolArray:
		return "list_contains_bool_array"
	default:
		return "builtin(?)"
	}
}
